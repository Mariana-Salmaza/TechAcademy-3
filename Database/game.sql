...
INSERT INTO itens_da_cena (id_item, nome, descricao_positiva, descricao_negativa, comando_correto, id_cena_atual, id_cena_destino, interagivel) VALUES
(1, 'LANTERNA', 'Uma lanterna antiga, ainda com um pouco de óleo. Pode ajudar a iluminar o caminho em áreas escuras do castelo.', 'A lanterna não serve para nada aqui.', 'USE LANTERNA', 1, NULL, 1),
(2, 'CHAVE DE FERRO', 'Uma pequena CHAVE enferrujada, aparentemente usada para trancar algo.', 'Essa chave não parece servir para nada aqui.', 'USE CHAVE DE FERRO', 1, NULL, 1),
(3, 'DIÁRIO DO CONDE', 'Um velho DIÁRIO que fala sobre os segredos do castelo.', 'O diário não tem informações úteis neste momento.', 'USE DIÁRIO DO CONDE', 2, NULL, 1),
(4, 'MAPA DO CASTELO', 'Um MAPA antigo que pode ajudar a explorar o castelo.', 'O mapa não revela nada novo agora.', 'USE MAPA DO CASTELO', 2, NULL, 1),
(5, 'CAIXA DE OURO', 'Uma CAIXA trancada com um mecanismo complicado. Pode conter um item valioso.', 'A caixa está trancada e você não tem a chave certa para abri-la.', 'USE CAIXA DE OURO', 3, NULL, 1),
(6, 'ESPADA DE PRATA', 'Uma ESPADA antiga com inscrições mágicas. Pode ser útil em um confronto futuro.', 'A espada não tem utilidade imediata agora.', 'USE ESPADA DE PRATA', 3, NULL, 1),
(7, 'LIVRO DE FEITIÇOS', 'Um LIVRO que contém feitiços antigos e rituais. Pode ajudar a resolver o ENIGMA.', 'O livro não ajuda diretamente com o enigma agora.', 'USE LIVRO DE FEITIÇOS', 4, NULL, 1),
